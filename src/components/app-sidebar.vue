      ...
      menu: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              key: "laporan-treatment-tidak-laku",
              title: "Data Treatment Tidak Laku",
              to: "/laporan/treatment-tidak-laku",
              roles: [
                "administrator",
                "superuser",
                "it",
            ...
            {
              key: "laporan-pasien-paling-sering-belanja",
              title: "Pasien Paling Sering Belanja",
              to: "/laporan/pasien-paling-sering-belanja",
              roles: [
                "administrator",
                "superuser",
                "it",
            ...
            {
              key: "laporan-detail-treatment",
              title: "Data Laporan Detail Treatment",
              to: "/laporan/detail-treatment",
              roles: [
                "administrator",
                "superuser",
                "it",
            ...
            {
              key: "laporan-pasien-terakhir-transaksi",
              title: "Data Pasien Terakhir Transaksi",
              to: "/laporan/pasien-terakhir-transaksi",
              roles: [
                "administrator",
                "superuser",
                "it",
            ...
            {
              key: "laporan-pembayaran-fo",
              title: "Data Laporan Pembayaran FO",
              to: "/laporan/pembayaran-fo",
              roles: [
                "administrator",
                "superuser",
                "it",
            ...
            {
              key: "laporan-jumlah-peningkatan-pasien",
              title: "Data Laporan Jumlah Peningkatan Pasien",
              to: "/laporan/jumlah-peningkatan-pasien",
              roles: [
                "administrator",
                "superuser",
                "it",
            ...
            {
              key: "laporan-produk-resep-dokter",
              title: "Data Laporan Produk Resep Dokter",
              to: "/laporan/produk-resep-dokter",
              roles: [
                "administrator",
                "superuser",
                "it",
            ...
            {
              key: "laporan-bahan-treatment",
              title: "Lap. Bahan Treatment",
              to: "/laporan/bahan-treatment",
              roles: [
                "administrator",
                "superuser",
                "it",
