  ...
  <v-card elevation="2" class="mb-5">
    <v-card-text class="pa-6">
      <div class="section-header mb-5">
        <div>
          ...
          <div class="section-subtitle">
            Tentukan jenis layanan yang akan dimasukkan ke registrasi pasien
          </div>
        </div>
      ...
      <v-alert
        ...
        class="mb-5"
      >
        Pilih minimal satu layanan. Jika konsultasi dipilih, tentukan juga
        channel konsultasinya.
      </v-alert>
            ...
            >
              <div class="service-box__top">
                ...
                <v-checkbox
                  ...
                  @click.stop
                  @update:modelValue="
                    updateLayananField('ada_treatment', $event)
                  "
                />
              </div>
            ...
            >
              <div class="service-box__top">
                ...
                <v-checkbox
                  ...
                  @click.stop
                  @update:modelValue="
                    updateLayananField('ada_penjualan', $event)
                  "
                />
              </div>
