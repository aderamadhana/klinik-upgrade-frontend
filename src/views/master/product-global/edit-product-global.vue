<template>
  <div>
    <div class="page-header">
      <div>
        <h1 class="page-title">Edit Produk Global</h1>
        <p class="page-subtitle">
          Ubah data produk global dan konfigurasi produk per cabang
        </p>
      </div>
            ...
            >
              <div>
                ...
                <div class="text-body-2 text-medium-emphasis">
                  Atur supplier, harga jual, harga beli, stok, dan fee per
                  cabang.
                </div>
              </div>
  ...
  methods: {
    async initPage() {
      ...
      try {
        ...
        this.showSnackbar(
          this.getErrorMessage(error, "Gagal memuat halaman edit produk"),
          "error",
        );
    ...
    async submitForm() {
      ...
      try {
        await produkService.update(this.productId, this.payload);

        this.showSnackbar("Data produk berhasil diperbarui", "success");
        ...
        this.showSnackbar(
          this.getErrorMessage(error, "Gagal memperbarui data produk"),
          "error",
        );
      } finally {
