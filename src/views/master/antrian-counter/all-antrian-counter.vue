<template>
  <div>
    ...
    <confirm-delete-dialog
      ...
      subtitle="Data counter antrian akan dihapus secara soft delete."
      question="Yakin ingin menghapus counter antrian ini?"
      :item-title="selectedItem?.nama || '-'"
      warning-text="Data counter antrian akan dihapus secara soft delete."
