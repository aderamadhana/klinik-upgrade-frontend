<template>
  <div>
    ...
    <confirm-delete-dialog
      ...
      subtitle="Data supplier akan dihapus secara soft delete."
      question="Yakin ingin menghapus supplier ini?"
      :item-title="selectedSupplier?.nama || '-'"
      warning-text="Data supplier akan dihapus secara soft delete."
