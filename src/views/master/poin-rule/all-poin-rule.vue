<template>
  <div>
    ...
    <confirm-delete-dialog
      ...
      subtitle="Data poin rule akan dihapus secara soft delete."
      question="Yakin ingin menghapus data poin rule ini?"
      :item-title="selectedItem?.nama_rule || '-'"
      warning-text="Data poin rule akan dihapus secara soft delete."
