  ...
  <div>
    ...
    >
      <div>
        <div class="text-h5 font-weight-bold text-high-emphasis">
          Faktur Deposit Accurate
        </div>
        <div class="text-body-2 text-medium-emphasis mt-1">
          Upload faktur deposit treatment ke Accurate berdasarkan invoice
          deposit lunas.
        </div>
      </div>
        ...
        <v-row dense>
          ...
          <v-col cols="12" sm="8" md="4">
            <v-text-field
              ...
              label="Cari"
              placeholder="Pasien, no faktur, faktur Accurate, pengirim"
    ...
    <v-card variant="flat" border rounded="lg">
      ...
      >
        ...
        <template #[`item.total_deposit`]="{ item }">
      ...
      <v-card rounded="lg" max-height="88vh" class="overflow-hidden">
            ...
            <div class="d-flex align-center ga-3">
              ...
              <div>
                <div class="text-subtitle-1 font-weight-bold text-white">
                  Upload Faktur Deposit ke Accurate
                </div>
                <div class="text-body-2 text-white">
                  Kirim invoice deposit sebagai faktur penjualan ke Accurate.
                </div>
              </div>
            </div>
        ...
        <v-card-text class="pa-4">
          <v-alert
            ...
            class="mb-4"
          >
            Invoice deposit akan dikirim sebagai faktur penjualan ke Accurate.
          ...
          <v-card class="rounded-lg border" elevation="0">
            <v-card-text class="pa-4">
              <div class="d-flex align-start ga-3 mb-4">
                ...
                <div>
                  <div class="text-subtitle-2 font-weight-bold">
                    Detail Faktur Deposit
                  </div>
                  <div class="text-body-2 text-medium-emphasis">
                    Pastikan tanggal faktur, pasien, nomor faktur, dan total
                    deposit sudah sesuai.
                  </div>
                </div>
              </div>
              ...
              <v-list density="compact" lines="two" border rounded>
                ...
                <v-list-item
                  title="No. Faktur"
                  :subtitle="selectedRow?.no_invoice || '-'"
                />
                ...
                <v-list-item>
                  ...
                  <v-list-item-subtitle>
                    <span class="font-weight-bold text-success">
                      {{ formatCurrency(selectedRow?.total_deposit || 0) }}
                    </span>
                  </v-list-item-subtitle>
                </v-list-item>
              </v-list>
...
export default {
  name: "SettlementDepositAccurate",
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { title: "No. Faktur", key: "no_invoice", minWidth: 150 },
        {
          title: "Total Deposit",
          key: "total_deposit",
          align: "end",
  ...
  methods: {
    ...
    async loadData() {
      ...
      this.loading = true;
      try {
        const response = await accurateSettlementService.getDeposit({
        ...
        this.showSnackbar(
          this.getErrorMessage(
            error,
            "Gagal mengambil data faktur deposit Accurate.",
          ),
          "error",
        );
      } finally {
    ...
    async uploadSelected() {
      ...
      try {
        const response = await accurateSettlementService.uploadDeposit({
          pembayaran_id: this.selectedRow.pembayaran_id,
        });

        this.showSnackbar(
          response?.message || "Faktur deposit berhasil dikirim ke Accurate.",
          "success",
        );
        ...
        this.showSnackbar(
          this.getErrorMessage(error, "Upload faktur deposit Accurate gagal."),
          "error",
        );
      } finally {
