    ...
    <div class="page-header">
      <div>
        ...
        <p class="page-subtitle">
          Buat voucher diskon baru dengan pengaturan kategori, periode, nilai
          diskon, dan template
        </p>
      </div>
...
export default {
  ...
  methods: {
    async submitForm() {
      ...
      try {
        console.log("Payload voucher diskon:", this.payload);
        this.dialogPreview = true;
        this.showSnackbar("Voucher diskon berhasil diproses", "success");
      } catch (error) {
        this.showSnackbar("Gagal memproses voucher diskon", "error");
      } finally {
        this.loading = false;
      }
    },
