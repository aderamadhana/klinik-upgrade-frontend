<template>
  <div>
    ...
    <confirm-delete-dialog
      ...
      subtitle="Voucher akan dinonaktifkan tanpa menghapus riwayat transaksi."
      question="Yakin ingin menghapus voucher ini?"
      :item-title="selectedItem?.nama || '-'"
      warning-text="Data voucher akan dihapus secara soft delete."
