...
export default {
  ...
  async getSaldoPoin(id, params = {}) {
    const response = await api.get(`/administrasi/pasien/${id}/saldo-poin`, {
      params,
    });
  ...
  async redeemPoin(id, payload = {}) {
    const response = await api.post(
      `/administrasi/pasien/${id}/saldo-poin/redeem`,
      payload,
    );
  ...
  async voidRedeemPoin(id, ledgerId, payload = {}) {
    const response = await api.post(
      `/administrasi/pasien/${id}/saldo-poin/${ledgerId}/void`,
      payload,
    );
